...
-   **Phase Architecture**: The system is modularized into several feature phases, including:
    ...
    -   **BIG ALPHA (December 2025)**: Advanced institutional-grade trading enhancements:
        ...
        -   **Phase 4**: Intent Intelligence - Whale Intent Filter (blocks diverging Whale CVD >$100k), Liquidation Magnet 2.0 (90min hold if moving toward cluster), Fear & Greed Regime Multiplier (40% size reduction if F&G > 80), Hyperparameter Optimizer (auto-tunes Whale CVD threshold every 12h)
